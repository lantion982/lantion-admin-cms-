...
@section('content')
	    ...
	    <div class="topbox">
	        <div class="box box-info box-solid">
	            <div class="box-header">
	                <h5 class="box-title">短信验证码</h5>
	                <div class="box-tools pull-right">
		                <button type="button" title="新增验证码" class="btn btn-default btn-sm" onclick="addSMSInfo()">
	                        <i class="fa fa-plus-square"></i>&nbsp;新增验证码
	                    </button>
    ...
    <div class="panel panel-default">
        <div id="ajaxContent"  class="box-body table-responsive no-padding">
             @include('manager.log.SMSList')
        </div>
    </div>
    <script type="text/javascript" src="{{'/js/page/log/phoneSMS.js?'.time()}}"></script>
@endsection
