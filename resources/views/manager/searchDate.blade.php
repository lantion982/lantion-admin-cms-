...
<div class="col-md-6 col-sm-6 col-xs-12 hidden-sm hidden-xs">
	<div class="btn-group">
		...
		<div class="form-control no-border no-padding" id="day">
			<a href="#" class="btn btn-default" onclick="setdate(1,-1,1);" title="前一天">
				<i class="fa fa-angle-double-left"></i>
			</a>
			<a href="#" class="btn btn-default" onclick="setdate(1,0,1);">今天</a>
			<a href="#" class="btn btn-default" onclick="setdate(1,1,1);" title="后一天">
	...
	<div class="btn-group">
		...
		<div class="form-control no-border no-padding">
			...
			<a href="#" class="btn btn-default" onclick="setdate(2,-1,1);" title="上一周">
				<i class="fa fa-angle-double-left"></i>
			</a>
			<a href="#" class="btn btn-default" onclick="setdate(2,0,1);">本周</a>
			<a href="#" class="btn btn-default" onclick="setdate(2,1,1);" title="下一周">
				<i class="fa fa-angle-double-right"></i>
			</a>
		</div>
	</div>
	<div class="btn-group">
		...
		<div class="form-control no-border no-padding">
			...
			<a href="#" class="btn btn-default" onclick="setdate(3,-1,1);" title="上个月">
				<i class="fa fa-angle-double-left"></i>
			</a>
			<a href="#" class="btn btn-default" onclick="setdate(3,0,1);">本月</a>
			<a href="#" class="btn btn-default" onclick="setdate(3,1,1);" title="下个月">
				<i class="fa fa-angle-double-right"></i>
			</a>
		</div>
	</div>
