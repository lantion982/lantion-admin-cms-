...
@section('content')
    ...
    <div class="panel panel-default">
        <div id="ajaxContent"  class="box-body table-responsive no-padding">
            @include('manager.finance.member.draw.drawListAjax')
        </div>
    </div>
    <script type="text/javascript" src="{{'/js/page/finance2/member/draw/drawApply.js?'.time()}}"></script>
@endsection
