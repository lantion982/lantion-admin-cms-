...
<div class="row">
    <div class="col-md-3 col-sm-6">
        ...
        <input type="text" id="keyword" name="keyword" placeholder="账号|手机号" class="form-control" value="{{$keyword}}">
    </div>
	<div class="col-md-3 col-sm-6">
		<label class="hidden-sm hidden-xs">变动类型</label>
		{{Form::select('move_type[]',$move_type,'common',['id'=>'move_type','class'=>'form-control selectpicker','multiple','data-live-search'=>'true'])}}
	</div>
    <div class="col-md-3 col-sm-6">
        <label for='bill_no' class="hidden-sm hidden-xs">会员信息</label>
        <input type="text" id="bill_no" name="bill_no" placeholder="订单号" class="form-control" value="{{$billNo}}">
    </div>
</div>
<div class="row">
