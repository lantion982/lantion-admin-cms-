...
<div class="row">
    <div class="topbox">
        <div class="box box-info box-solid">
            ...
            <div class="box-body">
                <div class="row">
                    <form id="searchForm" name="searchForm" class='form-horizontal form-bordered' method="get" action="{{route('getLoginIpList')}}">
                        <div class="row">
                            <div class="col-sm-2">
                                <label for="keyword" class="hidden-sm hidden-xs">关键字</label>
                                <input type="text" id="keyword" name="keyword" placeholder="会员帐号" class="form-control" value="{{$keyword}}">
                            </div>
                            <div class="col-sm-2">
                                <label for="keyword" class="hidden-sm hidden-xs">IP</label>
                                <input type="text" id="ip" name="ip" placeholder="IP" class="form-control" value="{{$ip}}">
                            </div>
                            <div class="col-sm-2">
                            ...
                            <div class="col-sm-1">
                                ...
                                <select class="form-control" id="page_count" name="page_count">
                                    ...
                                    <option value="{{$pval}}" @if($page_count==$pval) selected @endif>{{$pval}}条</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-sm-3">
    ...
    <div id="ajaxContent" class="box-body table-responsive no-padding">
        <table id="tbl-activities" class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{$log->Member->display_name??$log->login_name}}</td>
                    <td>{{$log->login_ip}}</td>
