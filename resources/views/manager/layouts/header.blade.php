            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img  src="{{'/images/admin/user2019.jpg'}}" class="user-image" alt="User Image">
                        <span class="hidden-xs">{{auth('admin')->user()->login_name}}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <li class="user-header">
                            <img src="{{'/images/admin/user2019.jpg'}}" class="img-circle" alt="User Image">
                            <p>
                               {{auth('admin')->user()->login_name}}
                            </p>
                        </li>
                        ...
                        <li class="user-footer">
                            ...
                            <div class="pull-right">
                                <a href="{{url('/manager/logout')}}"  class="btn btn-default btn-flat">退出</a>
                            </div>
                        </li>
                    </ul>
                </li>
