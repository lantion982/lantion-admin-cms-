...
@section('content')
    ...
    <div class="panel panel-default">
        <div id="ajaxContent"  class="box-body table-responsive no-padding">
            @include('manager.report.backwater.upgradeDetailList')
        </div>
    </div>
    <script type="text/javascript" src="{{'/js/page/report/backwater/upgradeDetail.js?'.time()}}"></script>
@endsection
