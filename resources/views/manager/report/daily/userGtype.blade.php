...
@section('content')
		...
		<div class="topbox">
			<div class="box box-info box-solid">
				<div class="box-header">
					<h5 class="box-title">会员日报表-游戏类型</h5>
	...
	<div id="ajaxContent">
		@include('manager.report.daily.userGtypeAjax')
	</div>
	<script type="text/javascript" src="{{'/js/page/report/daily/userGtype.js?'.time()}}"></script>
@endsection
