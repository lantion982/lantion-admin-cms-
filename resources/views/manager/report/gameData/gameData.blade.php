...
@section('content')
    ...
    <div class="panel panel-default">
        <div id="ajaxContent"  class="box-body table-responsive no-padding">
            @include('manager.report.gameData.gameDataAjax')
        </div>
    </div>
    <script type="text/javascript" src="{{'/js/page/report/gameData/gameData.js?'.time()}}"></script>
@endsection
