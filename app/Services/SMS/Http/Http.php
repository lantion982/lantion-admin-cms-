...
class Http{
	 ...
	 * @return array
	 */
	public function post($url,$apiKey,$message,$mobile,$options = array()){
		return $this->request($url,self::POST,$apiKey,$message,$mobile,$options);
	}
	 ...
	 * @return array
	 */
	protected function request($url,$method = self::GET,$apiKey,$message,$mobile,$options = array()){
		...
		curl_setopt($this->curl,CURLOPT_USERPWD,'api:key-'.$apiKey);
		curl_setopt($this->curl,CURLOPT_POST,TRUE);
		curl_setopt($this->curl,CURLOPT_POSTFIELDS,array('mobile' => $mobile,'message' => $message));
