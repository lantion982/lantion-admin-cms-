...
<head>
    ...
    <link href="<?php echo e('/css/common.css'); ?>" rel="stylesheet"/>
            ...
            <div class="box-body">
                <div class="menu">
                    <ol class="breadcrumb mb1">
                        <li>
                            <a href="<?php echo e(route('picindex')); ?>">目录列表</a>
                        </li>
                        <li>首页</li>
                    </ol>
                </div>
                <div class="row fixlist">
                    ...
                    <div class="path">
                        <div class="pic"><a href="<?php echo e(route('piclist',['url'=>$val['path']])); ?>"><img src="/images/path.png"></a></div>
                        <div class="name"><a href="<?php echo e(route('piclist',['url'=>$val['path']])); ?>"><?php echo e($val['name']); ?></a></div>
                    </div>
...
<?php /**PATH /www/wwwroot/pic.magicma.net/resources/views/web/pic/index.blade.php ENDPATH**/ ?>