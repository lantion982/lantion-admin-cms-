...
<head>
    ...
    <link href="<?php echo e('/plus/adminlte2.4.8/dist/css/AdminLTE.css'); ?>" rel="stylesheet">
    ...
    <link href="<?php echo e('/plus/view/viewer.min.css'); ?>" rel="stylesheet">
    <!--瀑布流样式-->
    <link href="/css/plmm/base.css" rel="stylesheet">
    <link href="/css/plmm/index.css" rel="stylesheet">
    <!--JS-->
    <script src="<?php echo e('/plus/jQuery/jquery-1.11.3.min.js'); ?>"></script>
    ...
    <script src="<?php echo e('/js/common.js'); ?>"></script>
    <!--瀑布流主插件函数必须-->
    ...
    <div class="topbox">
        <div class="box box-info box-solid mg0">
            ...
            <div class="box-header">
                <h5 class="box-title"><?php echo e($username); ?> | 相册展示</h5>
            ...
            <div class="box-body">
                <div class="menu">
                    <ol class="breadcrumb mb1">
                        <li>
                            <a href="<?php echo e(route('picindex')); ?>">首页</a>
                        </li>
                        <?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li><a href="<?php echo e(route('piclist',['url'=>$val['path']])); ?>"><?php echo e($val['name']); ?></a></li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ol>
                </div>
                <div class="row fixlist">
                    <?php $__currentLoopData = $dirs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="path">
                            <div class="pic"><a href="<?php echo e(route('piclist',['url'=>$val['path'],'name'=>$val['name']])); ?>"><img src="/images/path.png"></a></div>
                            <div class="name"><a href="<?php echo e(route('piclist',['url'=>$val['path'],'name'=>$val['name']])); ?>"><?php echo e($val['name']); ?></a></div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <div class="content">
                    ...
                    <div class="waterfull clearfloat" id="waterfull">
                        ...
                        <li class="item">
                            <a href="javascript:" class="a-img">
                                <img src="<?php echo e($val['path']); ?>" alt="<?php echo e($val['name']); ?>">
                            </a>
                            <div class="qianm clearfloat">
                                <span class="sp1"><?php echo e($val['size']); ?>K</span>
                                <span class="sp2" onclick="delpic('<?php echo e($val['path']); ?>')">删除</span>
                                <span class="sp3"><?php echo e($val['time']); ?>&nbsp;</span>
                            </div>
                        </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $(window).scroll(function(){
            ...
            if(maxTop<($(window).height()+$(window).scrollTop())){
                loading.data('on',false).fadeIn(800);
                let posturl = '<?php echo e(route('piclist',['url'=>$path])); ?>';
                $.ajax({type:'post',url:posturl,data:{'page':page,'_token':'<?php echo e(csrf_token()); ?>'},dataType:'json',success:function(data){
                        if(data.status==1){
    ...
    <?php endif; ?>
    function delpic(url){
        $.ajax({type:'post',url:'<?php echo e(route("picdel")); ?>',data:{'url':url,'_token':'<?php echo e(csrf_token()); ?>'},dataType:'json',success:function(data){
                if(data.status==1){
                    layer.alert(data.msg,{icon:1,closeBtn:0,offset:['50px']},function(){
                        location.href='<?php echo e(route('piclist',['url'=>$path])); ?>';
                    });
                }else{
                    layer.alert(data.msg,{icon:2,closeBtn:0,offset:['50px']});
                    return false;
...
<?php /**PATH /www/wwwroot/pic.magicma.net/resources/views/web/pic/list.blade.php ENDPATH**/ ?>