<script language="JavaScript">
    ...
    function setdate(a,b,dateonly = 0){
        ...
        if(a==1){
            ...
            if(b==0){
                $('#addyear').val(0);
                startime = '<?php echo e(date('Y-01-01')); ?>';
                endtime = '<?php echo e(date('Y-m-d')); ?>';
            }else if(b== -1){
                startime = '<?php echo e(date("Y-01-01",strtotime("-1 year"))); ?>';
                endtime = '<?php echo e(date('Y-12-31',strtotime("-1 year"))); ?>';
            }else if(b==1){
                startime = '<?php echo e(date('Y-01-01',strtotime("+1 year"))); ?>';
                endtime = '<?php echo e(date('Y-12-31',strtotime("+1 year"))); ?>';
            }
...
<?php /**PATH /www/wwwroot/pic.magicma.net/resources/views/manager/searchScript.blade.php ENDPATH**/ ?>